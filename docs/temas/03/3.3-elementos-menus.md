...
!!! info "Revisa la documentación oficial:"
    La documentación oficial siempre es el mejor lugar para profundizar en los detalles y ver ejemplos actualizados. Aquí tienes algunos enlaces útiles:

    - [Scaffold en Jetpack Compose](https://developer.android.com/develop/ui/compose/components/scaffold?hl=es-419)<br/>
...
!!! example "Ejemplo scaffold"
    ...
    - **Drawer**: cajón lateral para navegación adicional o configuraciones.

> **Lee este post para un ejemplo completo** de uso de Scaffold en Compose: [Scaffold en Jetpack Compose: Estructura básica para tu UI](https://www.develou.com/scaffold-en-jetpack-compose/)


## 2. **Menus**

Los menús son componentes de interfaz de usuario que permiten a los usuarios seleccionar opciones o acciones de una lista desplegable. En Jetpack Compose, puedes crear menús utilizando la función `DropdownMenu` y `ExposedDropdownMenuBox`.

!!! info "Revisa la documentación oficial:"
    Documentación oficial para profundizar en los detalles y ver ejemplos actualizados:
    
    - [Menus en Jetpack Compose](https://developer.android.com/develop/ui/compose/components/menu?hl=es-419)
    - [Menus en Material Design](https://m3.material.io/components/menus/overview)

### 2.1. Menú desplegable (DropdownMenu)

En este punto vamos a ver el uso de [menús](https://material.io/components/menus) en Compose, con el fin de desplegar una lista de opciones en superficies que aparecen temporalmente hasta que el usuario selecciona una de ellas, o cancela la selección.
...
## 3. TopAppBar, BottomBar y FloatingActionButton

### 3.1. TopAppBar

La barra de aplicaciones superior (TopAppBar) es un componente clave en la interfaz de usuario de muchas aplicaciones. Proporciona un espacio para el título de la pantalla, acciones y navegación.

Revisa la siguiente documentación para más detalles sobre su uso:

- [TopAppBar en Jetpack Compose](https://developer.android.com/develop/ui/compose/components/app-bars?hl=es-419)
- [TopAppBar en Material Design](https://m3.material.io/components/app-bars/overview)
- [TopAppBar playgroud](https://foso.github.io/Jetpack-Compose-Playground/material/topappbar/)


### 3.2. BottomBar

La barra inferior (BottomBar) es otro componente importante que se utiliza para la navegación y las acciones en la parte inferior de la pantalla.

Revisa la siguiente documentación para más detalles sobre su uso:

- [BottomBar en Jetpack Compose](https://developer.android.com/develop/ui/compose/components/app-bars?hl=es-419)
- [BottomBar en Material Design](https://m3.material.io/components/toolbars/overview)
- [BottomBar playgroud](https://foso.github.io/Jetpack-Compose-Playground/material/bottombar/)


### 3.3. FloatingActionButton

El botón de acción flotante (FloatingActionButton o FAB) es un componente que representa la acción principal en una pantalla. Suele ser un botón circular que flota sobre el contenido.

Revisa la siguiente documentación para más detalles sobre su uso:

- [Documentación Jetpack Compose](https://developer.android.com/develop/ui/compose/components/fab?hl=es-419)
- [Material Design](https://m3.material.io/components/floating-action-button/overview)
- [Playgroud](https://foso.github.io/Jetpack-Compose-Playground/material/floatingactionbutton/)


### 3.4. Drawer

El drawer (cajón) es un componente de navegación que se desliza desde el borde de la pantalla para mostrar opciones de navegación adicionales.

Revisa la siguiente documentación para más detalles sobre su uso:

- [Drawer en Jetpack Compose](https://developer.android.com/develop/ui/compose/components/drawer?hl=es-419)
- [Drawer en Material Design](https://m3.material.io/components/navigation-drawer/overview)
- [Drawer playgroud](https://foso.github.io/Jetpack-Compose-Playground/material/modaldrawer/)